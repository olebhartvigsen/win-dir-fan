...
static constexpr Strings kDe = {
    ...
    L"Zuletzt in Explorer geöffnet",
...
static constexpr Strings kSw = {
    ...
    L"Faili za hivi karibuni za Kichunguzi",
...
static constexpr Strings kFr = {
    ...
    L"Documents",
    L"Fichiers r\u00e9cents",
    L"Fichiers r\u00e9cents de l\u2019Explorateur",
...
static constexpr Strings kIt = {
    ...
    L"Documenti",
    L"File recenti",
    L"File recenti di Esplora risorse",
...
static constexpr Strings kEs = {
    ...
    L"Archivos recientes del Explorador",
...
static constexpr Strings kPt = {
    ...
    L"Ficheiros recentes do Explorador",
...
static constexpr Strings kHi = {
    ...
    L"\u0926\u0938\u094d\u0924\u093e\u0935\u0947\u095b\u093c",
    L"\u0939\u093e\u0932 \u0915\u0940 \u095e\u093c\u093e\u0907\u0932\u0947\u0902",
    L"\u090f\u0915\u094d\u0938\u092a\u094d\u0932\u094b\u0930\u0930 \u0915\u0940 \u0939\u093e\u0932 \u0935\u093e\u0932\u0940 \u095e\u093e\u0907\u0932\u0947\u0902",
...
static constexpr Strings kFi = {
    ...
    L"Resurssienhallinnan viimeisimm\u00e4t tiedostot",
...
static constexpr Strings kRo = {
    ...
    L"Documente",
    L"Fi\u0219iere recente",
    L"Fi\u0219iere recente din Explorer",
